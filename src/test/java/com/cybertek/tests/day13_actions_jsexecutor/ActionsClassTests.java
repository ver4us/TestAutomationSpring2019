...
public class ActionsClassTests {
    ...
    String downloadsOptionsLocator = "ui-id-4";
    String pdfOptionsLocator = "ui-id-5";
    //small circle
    ...
    public void hoverTest2(){
        ...
        for (WebElement image : images){
            //not necessary just to be able to see the hovering
    ...
    public void hoverTest3(){
        ...
        WebElement downloadsElement = driver.findElement(By.id(downloadsOptionsLocator));
        WebElement pdfElement = driver.findElement(By.id(pdfOptionsLocator));
